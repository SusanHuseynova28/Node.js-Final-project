  ...
  return (
    <header>
      <div className="bg-black text-white text-sm flex justify-between items-center px-10 py-3">
        ...
        <div className="flex space-x-4">
          <Link href="#">
            <span className="hover:underline cursor-pointer">Store Location</span>
          </Link>
          <Link href="#">
          ...
          <div className="flex justify-between items-center space-x-8 w-full">
            ...
            <div className="flex justify-center items-center">
              <div className="flex items-center space-x-8">
                ...
                >
                  <Link href="/home" className="underline-animation cursor-pointer">
                    HOME
                  </Link>
                  <span className="mt-1">
                    <LuChevronDown />
                    ...
                    <div className="absolute top-full left-0 pt-2 bg-white border shadow-lg z-50 w-[240px] ">
                      <ul className="text-left">
                        {[
                          ...
                          <li key={index} className="px-4 py-2 relative underline-animation-item">
                            {item}
                          </li>
                        ))}
                      </ul>
      ...
      <CardSidebar isSidebarOpen={isSidebarOpen} toggleSidebar={toggleSidebar} />
    </header>
  );
}