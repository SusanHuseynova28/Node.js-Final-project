  ...
  return (
    <header>
      ...
      <div className="flex justify-between items-center px-10 py-8 border-b">
        ...
        <div className="text-xl font-bold flex justify-center items-center pr-[14rem] flex-grow">
          <svg
            width="210"
            height="27"
            viewBox="0 0 210 27"
      ...
      <nav className="bg-white border-t relative h-[1.2rem]">
          ...
          <div className="flex justify-between items-center space-x-8 w-full">
            ...
            <div className="flex items-center space-x-8">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm">( +800 ) 1234 56</span>
              </div>
